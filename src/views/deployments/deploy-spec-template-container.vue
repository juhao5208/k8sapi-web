            ...
            <el-form-item>
              <el-form style="margin-bottom: 20px" :inline="true" v-for="(item,cindex) in containers">
                ...
                <el-form-item label="镜像">
                  ...
                  <el-button type="primary" style="margin-left: 20px" @click="containers.splice(cindex,1)"><i
                ...
                <el-form-item label="端口设置" style="width: 100%">
                  ...
                  <el-form v-for="(port,portindex) in item.ports">
                    ...
                    <el-form-item>
                      <el-button type="primary" style="margin-left: 20px" @click="item.ports.splice(portindex,1)"><i
                        class="el-icon-minus"></i></el-button>
                    </el-form-item>
