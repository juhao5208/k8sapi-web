  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="名称" width="280">
        <template slot-scope="scope">
          <p>
            <router-link :to="{name:'CreateConfigmaps',
          params:{ns:scope.row.NameSpace,name: scope.row.Name  }}">{{ scope.row.Name }}
            </router-link>
          </p>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="100" align="center">
        <template slot-scope="scope">
          <el-button type="danger" @click="()=>rmConfigMap(scope.row.NameSpace,scope.row.Name )" icon="el-icon-delete"
                     circle></el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import {getList, rmConfigMap} from '@/api/configmaps'
