      ...
      <div>
        ...
        <el-form label-width="80px">
          ...
          <el-form-item label="私钥内容">
            <el-input placeholder="-----BEGIN RSA PRIVATE KEY-----开头的内容" type="textarea" :row="2"
                      v-model="kvs[0].value"></el-input>
            <a href="javascript:" class="file">从文件导入
              <input @change="()=>fileChange('filekey')" ref="filekey" type="file"
                     accept=".txt,.pem,.key,.pkey"></input>
            </a>
          </el-form-item>
          ...
          <el-form-item label="证书内容">
            <el-input placeholder="-----BEGIN CERTIFICATE-----开头的内容" type="textarea" :row="2"
                      v-model="kvs[1].value"></el-input>
            <a href="javascript:" class="file">从文件导入
              <input @change="()=>fileChange('filecrt')" type="file" ref="filecrt"
                     accept=".txt,.pem,.crt,.cert"></input>
            </a>
          </el-form-item>
